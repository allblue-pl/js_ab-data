...
import DBFieldInfo from "./FieldInfo.js";
import TableDef, {                          } from "./TableDef.js";
import TableInfo from "./TableInfo.js";
import ABDField from "./abd-fields/ABDField.js";
import ABDColumnRef from "./abd-fields/ABDColumnRef.js";
...
class DatabaseInfo {
    ...
    static Compare_Fields(columnName        , scheme            , 
            scheme_TableDef          , scheme_Field          , 
            db_Info              , tableInfo__DB           , 
            db_FieldInfo             )          {
    ...
    static Compare_Tables(scheme            , scheme_TableDef          , 
            db_Info              , db_TableInfo           )  
                                      {
        let actions                            = {
        ...
        for (let [ columnName, column ] of scheme_TableDef.columns) {
            ...
            if (db_FieldInfo === null) {
                ...
                actions.create.push({
                    name: columnName,
                    field: scheme.parseField(column.field),
                });
                continue;
            }

            let scheme_Field = scheme.parseField(column.field);
    ...
    static Compare_TableIndexes(scheme            , scheme_TableDef          , 
            db_Info              , db_TableInfo           )  
                                           {
        let actions                                 = {
            tableDef: scheme_TableDef,
