...
declare class DatabaseInfo {
    #private;
    static Compare(scheme: DataScheme, db_Info: DatabaseInfo): DatabaseInfo_DBActions;
    static CompareIndexes(scheme: DataScheme, db_Info: DatabaseInfo): DatabaseInfo_DBIndexActions;
    static Compare_Fields(columnName: string, scheme: DataScheme, scheme_TableDef: TableDef, scheme_Field: ABDField, db_Info: DatabaseInfo, tableInfo__DB: TableInfo, db_FieldInfo: DBFieldInfo): boolean;
