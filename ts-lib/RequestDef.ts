...
class RequestDef {
    ...
    defA(actionName: string, actionType: "r"|"w",
            ...
            successDef: {[propertyName: string]: ABDataDefValueType},
            failureDef: {[propertyName: string]: ABDataDefValueType} = {}): RequestDef {
...
type RequestDef_ActionDef = {
    ...
    argsDef: {[argName: string]: ABDataDefValueType},
    successDef: {[propertyName: string]: ABDataDefValueType},
    failureDef: {[propertyName: string]: ABDataDefValueType},
};