import ts0, { ts0Virtual, type TS0RawArray, type TS0RawObject } from "@allblue/ts0";
...
export default abstract class RequestProcessor {
    ...
    async processRequest_Async(request: RequestInfo_Parsed, transactionId: number|null = null): 
            Promise<Response> {
