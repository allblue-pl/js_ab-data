...
type ColumnInfos = Array<[ string, ABDAutoIncrementId ] |
        [ string, ABDBlob, ABDBlobValidator_Args? ] |
        [ string, ABDBool, ABDBoolValidator_Args? ] |
        [ string, ABDDate, ABDTimeValidator_Args? ] |
        [ string, ABDDateTime, ABDTimeValidator_Args? ] |
        ...
        [ string, ABDTime, ABDTimeValidator_Args? ]>;
